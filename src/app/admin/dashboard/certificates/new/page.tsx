            ...
            <header className="sticky top-0 z-50 bg-[var(--background)]/80 backdrop-blur-xl border-b border-[var(--border)]">
                <div className="max-w-4xl mx-auto px-6 py-5">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h1 className="text-2xl font-black tracking-tighter uppercase">Register Certificate</h1>
                            <p className="text-xs font-black uppercase tracking-widest opacity-30 text-[var(--foreground)] mt-1">Credential Entry</p>
                        </div>
                    </div>
                </div>
            </header>
