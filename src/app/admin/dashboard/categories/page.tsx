                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                <h1 className="text-2xl font-black tracking-tighter uppercase">Category Registry</h1>
                                {isSyncing && (
                                    <motion.div
                            ...
                            <p className="text-xs font-black uppercase tracking-widest opacity-30 text-[var(--foreground)] mt-1">Foundry Classification</p>
                        </div>
                    </div>
                </div>
            </header>
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                <p className="text-[var(--foreground-muted)] text-lg font-medium mb-12 leading-relaxed">
                                    Are you certain you wish to permanently terminate this category? Projects utilizing it will default to <span className="text-blue-500 font-bold uppercase tracking-wider">Web App</span>.
                                </p>
