...
export default function NewProjectPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSessionUploads([]); // Clear so they aren't deleted on unmount or manual cancel
    ...
    const addImage = (url: string) => {
        ...
        // Track as a session upload for potential cleanup
    ...
    const removeImage = async (index: number) => {
        ...
        // If it's an uploaded image (R2), delete it from storage
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            ...
                            >
                                {loading && sessionUploads.length > 0 ? (
                                    <div className="flex items-center gap-3">
